...
source("/Users/michellemeier/Semesterproject/ARCHS4/hypoxia/runfile_pi3k.R")
...
pi3k_res_5 = pi3k_res_4[pi3k_res_4$case == TRUE,]

#only keep the series which are case direction 
...
#all methods
#gsva
GSVA_rank <- findRankPathway(meta_frame = pi3k_res_5, expression_frame = expression_pi3k_cutoff, geneset = gene_sets, pathway_wanted = "HALLMARK_PI3K_AKT_MTOR_SIGNALING",
                             method_wanted = "gsva")
#ssGSEA
ssGSEA_rank <- findRankPathway(meta_frame = pi3k_res_5, expression_frame = expression_pi3k_cutoff, geneset = gene_sets, pathway_wanted = "HALLMARK_PI3K_AKT_MTOR_SIGNALING",
                               method_wanted = "ssgsea")
#zscore
zscore_rank <- findRankPathway(meta_frame = pi3k_res_5, expression_frame = expression_pi3k_cutoff, geneset = gene_sets, pathway_wanted = "HALLMARK_PI3K_AKT_MTOR_SIGNALING",
                               method_wanted = "zscore")
#PLAGE
plage_rank <- findRankPathway(meta_frame = pi3k_res_5, expression_frame = expression_pi3k_cutoff, geneset = gene_sets, pathway_wanted = "HALLMARK_PI3K_AKT_MTOR_SIGNALING",
                              method_wanted = "plage")
#singscore
singscore_rank <- findRankPathwaySingscore(meta_frame = pi3k_res_5, expression_frame = expression_pi3k_cutoff, geneset = geneSet, pathway_wanted = "HALLMARK_PI3K_AKT_MTOR_SIGNALING")
...
bp_1 <- bp_1 + labs(title ="PI3K pathway score (case)",
