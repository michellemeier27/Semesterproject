...
source("/Users/michellemeier/Semesterproject/ARCHS4/hypoxia/runscript_p53.R")
...
p53_res_5 = p53_res_4[p53_res_4$case == TRUE,]
...
#all methods
#gsva
GSVA_rank <- findRankPathway(meta_frame = p53_res_5, expression_frame = expression_p53_cutoff, geneset = gene_sets, pathway_wanted = "HALLMARK_P53_PATHWAY",
                             method_wanted = "gsva")
#ssGSEA
ssGSEA_rank <- findRankPathway(meta_frame = p53_res_5, expression_frame = expression_p53_cutoff, geneset = gene_sets, pathway_wanted = "HALLMARK_P53_PATHWAY",
                               method_wanted = "ssgsea")
#zscore
zscore_rank <- findRankPathway(meta_frame = p53_res_5, expression_frame = expression_p53_cutoff, geneset = gene_sets, pathway_wanted = "HALLMARK_P53_PATHWAY",
                               method_wanted = "zscore")
#PLAGE
plage_rank <- findRankPathway(meta_frame = p53_res_5, expression_frame = expression_p53_cutoff, geneset = gene_sets, pathway_wanted = "HALLMARK_P53_PATHWAY",
                              method_wanted = "plage")
#singscore
singscore_rank <- findRankPathwaySingscore(meta_frame = p53_res_5, expression_frame = expression_p53_cutoff, geneset = geneSet, pathway_wanted = "HALLMARK_P53_PATHWAY")
...
bp_1 <- bp_1 + labs(title ="p53 pathway score (control)",
                subtitle = "hallmark gene sets")
show(bp_1)
ggsave(plot = bp_1, filename = "control_hallmarks_p53.png", path = "/Users/michellemeier/Semesterproject/ARCHS4/results/pathway_scoring/hallmarks/case")
